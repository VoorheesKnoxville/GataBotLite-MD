...
const smsAvisoAG = () => { return `╰⊱⚠️⊱ *ADVERTÊNCIA* ⊱⚠️⊱╮\n\n` }
const smsAvisoIIG = () => { return `╰⊱❕⊱ *INFORMAÇÃO* ⊱❕⊱╮\n\n` }
const smsAvisoFG = () => { return `╰⊱❌⊱ *ERRO* ⊱❌⊱╮\n\n` }
const smsAvisoMG = () => { return `╰⊱❗️⊱ *AÇÃO MALSUCEDIDA* ⊱❗️⊱╮\n\n` }
const smsAvisoEEG = () => { return `╰⊱📩⊱ *RELATÓRIO* ⊱📩⊱╮\n\n` }
const smsAvisoEG = () => { return `╰⊱💚⊱ *ÊXITO* ⊱💚⊱╮\n\n` }

const smsRowner = () => { return `\`\`\`ESSE COMANDO APENAS O NÚMERO DO BOT PODE USAR!!\`\`\`` }
const smsOwner = () => { return `\`\`\`ESSE COMANDO APENAS MEU DONO PODE USAR!!\`\`\`` }
const smsMods = () => { return `\`\`\`ESSE COMANDO APENAS ADMINS E MEU DONO PODEM USAR!!\`\`\`\`` }
const smsPremium = () => { return `\`\`\`ESSE COMANDO APENAS ESTÁ DISPONÍVEL PARA MEMBROS PREMIUM E MEU DONO!! PARA SER PREMIUM FALE COM MEU DONO\`\`\`` }
const smsGroup = () => { return `\`\`\`ESSE COMANDO APENAS PODE SER UTILIZADO EM GRUPOS!!\`\`\`` }
const smsPrivate = () => { return `\`\`\`ESSE COMANDO APENAS PODE SER UTILIZADO NO PV!!\`\`\`` }
const smsAdmin = () => { return `\`\`\`ESSE COMANDO É APENAS PARA ADMINS!!\`\`\`` }
const smsBotAdmin = () => { return `\`\`\`ATENÇÃO CHEFE, PARA USAR ESTE COMANDO PRECISO SER ADMIN!!\`\`\`` }
const smsUnreg = () => { return `\`\`\`PARA USAR ESSE COMANDO É NECESSÁRIO ESTAR REGISTRADO(A), DIGITE #verificar PARA REGISTRAR-SE!!\`\`\`` }
const smsRestrict = () => { return `\`\`\`ESSE COMANDO ESTÁ RESTRITO PELO MEU DONO!!\`\`\`` }

//main.js
const smsWelcome = () => { return `*╭┈⊰* @subject *⊰┈ ✦*\n*┊✨ BEM-VINDO(A)!!*\n┊💖 @user\n┊📄 *POR FAVOR, LEIA AS REGRAS DO GRUPO!!*\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ ✦*\n${String.fromCharCode(8206).repeat(850)}\n@desc`}
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ *@user*\n┊ *NÃO SERÁ A MSMA COISA SEM VC, NA VERDADE, SERÁ MELHOR!! TCHAU!! <3* 🌟\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
const smsSpromote = () => { return '*@user FOI PROMOVIDO COMO ADMIN DO GRUPO!! :)*'}
const smsSdemote = () => { return '*EI TIO(A) @user, TIREI SUA FUNÇÃO COMO ADMIN DO GRUPO, DEPOIS VC VOLTA!! <3*'}
const smsSdesc = () => { return '*ATENÇÃO!! DESCRIÇÃO DO GRUPO FOI ALTERADA:*\n\n@desc'}
const smsSsubject = () => { return '*ATENÇÃO!! O NOME DO GRUPO FOI ALTERADO:*\n@subject'}
const smsSicon = () => { return '*A CAPA DO GRUPO FOI ALTERADA GRUPO!! ;)*'}
const smsSrevoke = () => { return '*O LINK DO GRUPO FOI ATUALIZADO!!*\n*@revoke*'}
const smsConexion = () => { return `\n╭┈ ┈ ┈ ┈ ┈ • ${packname} • ┈ ┈ ┈ ┈ ┈╮\n┊ 💚 CONEXÃO COM ÊXITO NO WHATSAPP 💚\n╰┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈╯`} 
const smsCargando = () => { return `✨ CARREGANDO...\n`} 
const smsCodigoQR = () => { return `\n✅ FAVOR ESCANEAR O QR CODE, IRÁ EXPIRAR EM 45 SEGUNDOS. ✅`}
const smsConexionOFF = () => { return `\n⚠️ SEM CONEXÃO, FAVOR APAGAR A PASTA ${global.authFile} E ESCANEAR O QR CODE NOVAMENTE. ⚠️`}
const smsClearTmp = () => { return `\n╭▸ ☘️  MULTIMÍDIA ☘️\n┆• ARQUIVOS DA PASTA TMP APAGADOS.\n╰┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈◎`} 
const smspurgeSession = () => { return `\n╭▸ 🌻 ${global.authFile} 🌻\n┆• SESSÕES NÃO ESSENCIAIS APAGADAS.\n╰┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈◎`} 
const smspurgeOldFiles = () => { return `\n╭▸ 🌹 ARQUIVOS 🌹\n┆• ARQUIVOS RESIDUAIS APAGADOS.\n╰┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈◎`} 
const smspurgeSessionSB1 = () => { return `\n╭▸ 🌺 GataJadiBot 🌺\n┆• NADA A APAGAR. \n╰┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈◎`} 
const smspurgeSessionSB2 = () => { return `\n╭▸ 🌼 GataJadiBot 🌼\n┆• ARQUIVOS NÃO ESSENCIAIS APAGADOS.\n╰┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈◎`} 
const smspurgeSessionSB3 = () => { return `\n╭▸ ⚠️ GataJadiBot ⚠️\n┆• OCORREU UM ERRO.\n╰┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈◎\n`} 
const smspurgeOldFiles1 = () => { return `\n╭▸ ♻️ ARQUIVO ♻️\n┆•`} 
const smspurgeOldFiles2 = () => { return `APAGADO COM ÊXITO.\n╰┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈◎`} 
const smspurgeOldFiles3 = () => { return `\n╭▸ ⚠️ ARQUIVO ⚠️\n┆•`} 
const smspurgeOldFiles4 = () => { return `ERRO AO APAGAR.\n╰┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈ ┈◎\n`} 
...
const smsCreB = () => { return 'Pois não?'}
const smsCreC = () => { return 'Sempre a disposição para te ajudar. 😸'}

//info-cuentas-oficiales.js
const smsOfc1 = () => { return '🌸 *◜CONTAS OFICIAIS:◞* 🌸'}
const smsOfc2 = () => { return `*❥ _PARANGARICUTIRIMIRRUARO_ ${packname}*`}

//info-donar.js
const smsMensajeDonar = () => { return `🌼 .\n\n🌺 ${packname}`}
const smsTituloDonar = () => { return '*◜🌹❤️ . ❤️🌹◞*'}
const smsPrivadoDonar = () => { return '🍄 *_._*\n*_🌟_*'}
...
const smsLisA = () => { return '_*ESTÁ NESTES GRUPOS:*_'}
...
//info-estado.js
const smsCreApoyo = () => { return '✨ A P O I O'}
const smsEstado1 = () => { return 'ESTADO'}
const smsEstado2 = () => { return 'Versão'}
const smsEstado3 = () => { return 'Usuários/as'}
const smsEstado4 = () => { return 'Registrados/as'}
const smsEstado5 = () => { return 'Chat/s Proibido/s'}
const smsEstado6 = () => { return 'Usuários/as Proibidos/as'}
const smsEstado7 = () => { return 'Ativo(a) durante'}
...
const smsVl6 = () => { return '*NodeJS Uso de memória:*'}

//info-infobot.js
const smsBT1 = () => { return 'CRIADOR(A):'}
...
const smsBT8 = () => { return 'USUÁRIOS:'}
const smsBT9 = () => { return 'SUB BOTS ATIVOS:'}
const smsCreInfo = () => { return '🌟 I N F O R M A Ç Ã O : '}


//info-contacto.js
const smsContacto1 = () => { return ' Sou ' + packname + ' um Bot para WhatsApp dedicado em ajudá-lo(a) na administração do grupo. 😎'}
const smsContacto2 = () => { return 'Sou Owner de ' + packname + ' sí tienes alguna duda me la puedes decir ✌️'}
...
//convertidores.js
const smsConURL = () => { return lenguajeGB.smsAvisoMG() + '*RESPONDA COM UMA IMAGEM PARA CONVERTER EM LINK*'} 
const smsConURL1 = () => { return '🔗 *LINK*'} 
const smsConURL2 = () => { return '⚖️ *TAMANHO*'} 
const smsConURL3 = () => { return '♻️ *EXPIRADO*'} 
const smsConURL4 = () => { return '🪄 *LINK ENCURTADO*'}
const smsConURLERR1 = () => { return 'Infinita'} 
const smsConURLERR2 = () => { return 'Desconnhecida'} 

//convertidores.js
const smsConVIDEO = () => { return lenguajeGB.smsAvisoMG() + '*RESPONDA COM A FIGURINHA ANIMADA PARA CONVERTER EM VÍDEO.*'} 
const smsConVIDEO2 = () => { return lenguajeGB.smsAvisoMG() + '*APENAS FIGURINHA ANIMADA PARA CONVERTER EM VÍDEO.*'} 
const smsConVIDEO3 = () => { return lenguajeGB.smsAvisoEG() + '*✓ AQUI ESTÁ O SEU VÍDEO!! :)*'} 

//convertidores.js
const smsConGIF = () => { return lenguajeGB.smsAvisoMG() + '*RESPONDA COM UM VÍDEO PARA CONVERTER EM GIF COM ÁUDIO.*'} 
const smsConGIF2 = () => { return lenguajeGB.smsAvisoMG() + '*RESPONDA COM UM VÍDEO, O TIPO DE ARQUIVO USADO NÃO ESTÁ CORRETO.*'} 
const smsConGIF3 = () => { return lenguajeGB.smsAvisoEG() + '*GIF COM ÁUDIO, ABRA O GIF PARA OUVI-LO COM SOM!! :)*'} 
